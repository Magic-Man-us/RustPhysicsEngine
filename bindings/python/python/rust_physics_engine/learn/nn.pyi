...
Rust: `learn::nn::Mlp`
    """
    def __init__(self, layers: list[tuple[Matrix | Sequence[Sequence[float]], list[float]]], activation: Act, output_activation: Act) -> None: ...
    @staticmethod
    def new(sizes: list[int], activation: Act, output_activation: Act, rng: Rng) -> Mlp: ...
