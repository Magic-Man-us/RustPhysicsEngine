...
Rust: `optimization::lp::LpProblem`
    """
    def __init__(self, c: list[float], a: Matrix | Sequence[Sequence[float]], b: list[float], constraint_types: list[Cmp], bounds: list[tuple[float, float]], maximize: bool) -> None: ...
    @staticmethod
    def new(c: list[float], a: Matrix | Sequence[Sequence[float]], b: list[float], maximize: bool) -> LpProblem: ...
    def n(self) -> int: ...
    def m(self) -> int: ...
