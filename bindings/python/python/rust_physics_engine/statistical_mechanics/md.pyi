...
Rust: `statistical_mechanics::md::MdSystem`
    """
    @staticmethod
    def new(pos: list[Vec3 | Sequence[float]], vel: list[Vec3 | Sequence[float]], mass: list[float], box_size: Vec3 | Sequence[float], periodic: bool, potential: Potential, cutoff: float) -> MdSystem: ...
    @staticmethod
